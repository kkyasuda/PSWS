...
----->
    ...
    <div class="container main-content">
      <div class="row">          
          <h2><p class="bg-primary">　　遅刻早退届　</p></h2>          
...
<!--- 届け種類 --->
          <h3 class="modal-title"><p class="bg-primary">　遅刻早退届</p></h3>
        </div><!-- /modal-header -->
        <form name="checksend">
