...
----->
    ...
    <div class="container main-content">
      <div class="row">          
          <h2><p class="bg-primary">　　休日出勤届　</p></h2>          
          <form method="post" action="" class="form-horizontal" id="form_input">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">区分</label>                
                <div class="col-sm-2">
                    <p class="form-control-static">休日出勤</p>
                </div>           
            </div>
...
<!--- 届け種類 --->
          <h3 class="modal-title"><p class="bg-primary">　休日出勤届</p></h3>
        </div><!-- /modal-header -->
        <form name="checksend">
