...
----->
    ...
    <div class="container main-content">
      <div class="row">          
          <h2><p class="bg-primary">　　研修会出欠届　</p></h2>          
          <form method="post" action="" class="form-horizontal" id="form_input"> 
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">区分</label>
                <div class="col-sm-2">
                    <p class="form-control-static">研修会</p>
                </div>
              <div class="col-sm-3">
           ...
           <div class="form-group">
                <label for="date2" class="col-sm-3 control-label">研修日</label>
             <div class="col-sm-4">       
                <div class="input-group">
...
<!--- 届け種類 --->
          <h3 class="modal-title"><p class="bg-primary">　研修会出欠届</p></h3>
        </div><!-- /modal-header -->
        <form name="checksend">
          <div class="modal-body">
            <div class="form-horizontal">   
                ...
                <div class="form-group">
                    <label for="date1" class="col-xs-4 control-label">研修日</label>
                <div class="col-xs-8">
...
<!--- 届け種類 --->
              <p class="bg-primary">　研修会出欠届</p></h3>
        </div><!-- /modal-header -->
          <form name="checksend">
          <div class="modal-body">
...
//　メール送信、データ登録
            $.ajax({
            type: "POST",
            url: "todoke_benkyoukai_done.php",
