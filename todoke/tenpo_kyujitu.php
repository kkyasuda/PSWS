...
----->
    ...
    <div class="container main-content">
      <div class="row">          
          <h2><p class="bg-primary">　　店舗休日届　</p></h2>          
          <form method="post" action="" class="form-horizontal" id="form_input">
              
            <div class="form-group">
              <label for="input-name" class="col-sm-3 control-label">店舗</label>
                <div class="col-sm-9">
                    <p class="form-control-static"><?php echo htmlspecialchars($_SESSION['member_name'])?></p>
                </div>
              </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">区分</label>            
                <div class="col-sm-3">
                    <p class="form-control-static">店舗休日</p>
                </div>
            </div>
              <div class="form-group">
                        <label for="time1" class="col-sm-3 control-label">期間</label>               
                ...
                <div class="input-group">
                    <input id="datepicker1" type="text" class="form-control datepicker" name="date1">
                     ...
                     <div class="col-sm-3 col-lg-2"> 
                                <select class="form-control" name="kikan1" placeholder="選んで下さい">
                ...
                <div class="form-group">   
                       ...
                       <label for="time1" class="col-sm-3 col-lg-3 control-label"></label>
                   ...
                   <div class="col-sm-4 col-lg-3">
                    ...
                    <div class="col-sm-3 col-lg-2"> 
                                <select class="form-control" name="kikan2" placeholder="選んで下さい">
                                <option value="午前">午前</option>
                                <option value="午後">午後</option>
                                </select>
                   </div> 
...
<!--- 届け種類 --->
          <h3 class="modal-title"><p class="bg-primary">　店舗休日届</p></h3>
        </div><!-- /modal-header -->
        <form name="checksend">
          <div class="modal-body">
            <div class="form-horizontal">   
                <div class="form-group">
                    <label for="name" class="col-xs-4 control-label">店舗名</label>
                <div class="col-xs-8">
                    <p class="form-control-static"><?php echo htmlspecialchars($_SESSION['member_name'])?></p>
                </div>
                </div>
                ...
                <div class="form-group">
                    <label for="kikan" class="col-xs-4 control-label">期間</label>
                <div class="col-xs-5">
                    <input type="text" class="form-control" id="checkdate1" name="checkdate1" disabled>
                </div>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="checkkikan1" name="checkkikan1" disabled>
                </div>    
                </div>
                <div class="form-group">
                    <label for="kikan" class="col-xs-3 control-label"></label>
                    <label for="kikan" class="col-xs-1 control-label"> ～ </label>
                <div class="col-xs-5">
                    <input type="text" class="form-control" id="checkdate2" name="checkdate2" disabled>
                </div>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="checkkikan2" name="checkkikan2" disabled>
                </div> 
                </div>
                <div class="form-group">
...
// 確認モーダル表示準備
    $('#mcheck').on('show.bs.modal', function (event) {
        ...
        var tenponame="<?php echo htmlspecialchars($_SESSION['member_name'])?>";
        var input_kubun="店舗休日";
        var input_date1=document.forms["form_input"].elements["date1"].value;
        var input_kikan1=document.forms["form_input"].elements["kikan1"].value;
        var input_date2=document.forms["form_input"].elements["date2"].value;
        var input_kikan2=document.forms["form_input"].elements["kikan2"].value;
        var input_jiyu=document.forms["form_input"].elements["jiyu"].value;
  
        $('#checkdate1').val(input_date1);
        $('#checkkikan1').val(input_kikan1); 
        $('#checkkikan2').val(input_kikan2); 
...
//　入力ＯＫの処理
            ...
            var param2={ name: "<?php echo htmlspecialchars($_SESSION['member_name'])?>",
                        kubun: "店舗休日",
                        date1: $('#checkdate1').val(),
                        kikan1: $('#checkkikan1').val(),
                        date2: $('#checkdate2').val(),
                        kikan2: $('#checkkikan2').val(),
                        jiyu: $('#jiyu').val(),          
                      };
