...
----->
    ...
    <div class="container main-content">
      <div class="row">          
          <h2><p class="bg-primary">　　休暇欠勤届　</p></h2>          
          <form method="post" action="" class="form-horizontal" id="form_input">
              
                        <div class="form-group">
              <label for="input-name" class="col-sm-3 control-label">タイムカード番号</label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="time1" class="col-sm-3 control-label"></label>
                    <div class="form-inline">
                    <div class="col-sm-1"> 
...
<!--- 届け種類 --->
          <h3 class="modal-title"><p class="bg-primary">　休暇欠勤届</p></h3>
        </div><!-- /modal-header -->
        <form name="checksend">
